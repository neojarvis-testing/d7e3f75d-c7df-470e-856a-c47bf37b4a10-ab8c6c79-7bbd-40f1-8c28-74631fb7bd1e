...
const routes: Routes = [
  ...
  {path: 'addAdminRoom', component: AdminaddroomComponent, canActivate: [AuthGuard]},
  {path: 'adminviewroom', component: AdminviewroomComponent, canActivate: [AuthGuard]},
  {path: 'admineditRoom/:roomId', component: AdmineditroomComponent, canActivate: [AuthGuard]},
